	...
	<div class="col-xs-8 col-xs-offset-2">
		<form class="form-horizontal" role="form" action="register.php" method="get" enctype="text/plain">
			<div class="form-group">
				<label for="newUserName" class="col-sm-2 control-label">Username <i class="fa-solid fa-circle-info" data-toggle="tooltip" title="Username is case sensitive!"></i></label>
				<div class="col-sm-10">
