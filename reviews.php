...
?>
	<div class="container wrapper">
		...
		<?php
		while ($recipe_row = $result->fetch_assoc()):
			$recipe_id = $recipe_row['recipe_id'];
			$review_str = "SELECT * FROM reviews WHERE review_recipe_id='$recipe_id'";
						...
						<div class="panel panel-default"> 
							<div class="panel-heading">
								<h3 class="panel-title">
									<a href="recipedetails.php?id=<?= $recipe_row['recipe_id'] ?>"><?= $recipe_row['recipe_name'] ?></a>
								</h3>
							</div>
